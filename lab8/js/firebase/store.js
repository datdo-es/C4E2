...
async function createConverstaion(name, imageUrl, description, users, email) {
  try {
...
async function updateConversation(id, name, imageUrl, description, users, email) {
  try {
...
export { createUser, getUserByEmail, updateUser, createConverstaion, updateConversation, deleteConversation };